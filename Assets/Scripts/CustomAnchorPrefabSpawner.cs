...
public class CustomAnchorPrefabSpawner : MonoBehaviour
{
    ...
    internal Vector3 GetDirectionAwayFromClosestWall(MRUKAnchor anchor, MRUKRoom room, out int cardinalAxisIndex, List<int> excludedAxes = null)
    {
    ...
    private void SpawnPrefabsInternal(MRUKRoom room)
    {
        foreach (var anchor in room.Anchors)
        {
            ...
            prefab.GetComponentInChildren<TMPro.TextMeshPro>().text = String.Join(" ", anchor.AnchorLabels);
            ...
            if (anchor.VolumeBounds.HasValue)
            {
                ...
                {
                    GetDirectionAwayFromClosestWall(anchor, room, out cardinalAxisIndex);
                }
                ...
                if (prefabGroup.MatchAspectRatio)
                {
                    ...
                    {
                        GetDirectionAwayFromClosestWall(anchor, room, out cardinalAxisIndex, rotateToMatchAspectRatio ? new List<int> { 0, 2 } : new List<int> { 1, 3 });
                    }
